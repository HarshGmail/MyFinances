    ...
    <div className="flex mt-[5%] items-center justify-center bg-background overflow-hidden">
      <div className="w-full max-w-xl p-10 rounded-lg shadow-lg bg-card">
        <h2 className="text-2xl font-bold mb-6 text-center">
          Add Stock Transaction / Update Stock Portfolio
        </h2>
        <Form {...form}>
          <form
          ...
          >
            ...
            {/* Stock Price */}
            <FormLabel className="self-center">Stock Price</FormLabel>
            <FormField
              control={form.control}
              name="marketPrice"
              render={({ field }) => (
            ...
            {/* numOfShares */}
            <FormLabel className="self-center">Num Of Shares</FormLabel>
            <FormField
              control={form.control}
              name="numOfShares"
              render={({ field }) => (
            ...
            <FormLabel className="self-center">Stock Name</FormLabel>
            <FormField
              control={form.control}
              name="stockName"
              render={({ field }) => (
