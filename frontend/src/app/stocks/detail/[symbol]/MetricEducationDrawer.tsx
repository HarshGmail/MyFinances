        ...
        <div className="space-y-8 pb-8 pr-4 pl-4">
          ...
          <section>
            ...
            <div className="bg-muted/50 p-4 rounded-lg border mb-4">
              <p className="text-sm font-mono text-foreground">{definition.howCalculated}</p>
            </div>
            ...
            {realData && ((realData.label1 && realData.value1) || realData.result) && (
              <div className="bg-purple-50/50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs font-mono bg-black/20 p-4 rounded border border-purple-300/30">
                  ...
                  {(realData.label1 || realData.label2) && realData.result && (
                    <>
          ...
          <section className="border-t pt-6">
            ...
            <ul className="text-sm space-y-3 text-muted-foreground">
              <li>• Compare this metric with competitors in the same industry</li>
              <li>• Look at trends over time — is it improving or declining?</li>
              <li>• Don't rely on a single metric — always look at the full picture</li>
              <li>• Different industries have different benchmarks</li>
            </ul>
          </section>
        </div>
      </SheetContent>
